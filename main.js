...
const translations = {
    ko: {
        ...
        'system-morning-subtitle': '시스템 모니터링',
        'system-morning-desc': '실시간 CPU, RAM, 디스크, 네트워크 사용량 모니터링과 PC 최적화 도구.',
    ...
    en: {
        ...
        'system-morning-subtitle': 'System Monitoring',
        'system-morning-desc': 'Real-time CPU, RAM, disk, and network monitoring with PC optimization tools.',
